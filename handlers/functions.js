  ...
  try {
    ...
    function reset(track_info_msg, queue_info_msg) {
      let embed2 = new MessageEmbed()
        ...
        .setTitle("MonikaV3 | Music Queue")
          .setImage("https://cdn.discordapp.com/attachments/624420817211621381/862827407252521010/standard.gif")
        .setDescription(`Empty\nJoin a voice channel and queue songs by name or url in here.`)
      let embed3 = new MessageEmbed()
        .setColor(ee.color)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle("MonikaV3 | Currently no song is playing!")
          .setDescription(`> Join a voice channel and enter a song name or url to play.\n\n[Invite MonikaV3](https://tinyurl.com/3jdzuemv) • [Support Server](https://dsc.gg/isass.exe) • [Website](https://pastebin.com/v6zChTya)`)
          .setImage("https://media.giphy.com/media/WcMJVzM2JNH1xksK0P/giphy.gif")
    ...
    function QueueEmbed(client, player) {
      ...
      const embed = new MessageEmbed().setAuthor(`MonikaV3 | Music Queue`);
      const multiple = 15;
      const page = 1;
   ...
   embed.setColor(ee.color);
        embed.setImage("https://tinyurl.com/4ywcp9n7");
      embed.setFooter(ee.footertext, ee.footericon);
      return embed;
    }
    function format(millis) {
