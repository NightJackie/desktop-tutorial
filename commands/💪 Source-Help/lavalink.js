...
module.exports = {
	...
	run: async (client, message, args, user, text, prefix) => {
		message.channel.send(new MessageEmbed()
			...
			.addField("Bot's Source Code. ", "Don't just use the source for yourself,... please [invite](https://tinyurl.com/56jj86hv) me too![\`Click here\`](https://tinyurl.com/2h7btk3s)")
			.setColor(ee.color)
			...
			.addField("Download application.yml: ", "[\`application.yml\`](https://tinyurl.com/jxfjrabn)")
