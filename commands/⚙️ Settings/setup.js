...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    try {
      ...
      message.guild.channels.create("Monika - Requests", {
          type: 'category',
                  ...
                  message.guild.channels.create(`🎵｜requests`, {
                    ...
                    .then(async (channel3) => {
                      ...
                      let embed1 = new MessageEmbed()
                        ...
                        .setTitle("MonikaV3 | Request | Guide")
                      ...
                      let embed3 = new MessageEmbed()
                        ...
                        .setTitle("MonikaV3 | Currently no song is playing!")
                          .setDescription(`Join a voice channel and enter a song name or url to play.\n[Invite MonikaV3](https://tinyurl.com/hrr96x4) • [Support Server](https://dsc.gg/isass.exe)`)
